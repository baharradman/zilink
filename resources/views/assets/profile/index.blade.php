            ...
            <main id="main-body" class="main-body col-md-9">
                ...
                <section class="content-wrapper bg-white p-3 rounded-2 mb-2">
                    ...
                    <section class="row">
                        ...
                        </section><section class="col-6  my-2 py-2">
                            <section class="field-title">تلفن همراه</section>
                        ...
                        <section class="modal-dialog">
                            <section class="modal-content">
                                <section class="modal-header">
                                    <h5 class="modal-title" id="edit-profile-label"><i class="fa fa-plus"></i> ویرایش حساب </h5>
                                ...
                                <section class="modal-body">
                                    <form class="row" method="post" action="{{ route('profile.update') }}">
                                        ...
                                        <section class="col-6 mb-2">
                                            ...
                                            <input value="{{ auth()->user()->first_name ?? auth()->user()->first_name }}" type="text" name="first_name" class="form-control form-control-sm" id="first_name" placeholder="نام">
                                        </section>

                                        <section class="col-6 mb-2">
                                        <label for="mobile" class="form-label mb-1">شماره تلفن همراه </label>
                                        <input value="{{ auth()->user()->mobile ?? auth()->user()->mobile }}" type="text" name="mobile" class="form-control form-control-sm" id="mobile" placeholder="شماره تلفن">
                                        </section>

                                        <section class="col-6 mb-2">
                                            <label for="last_name" class="form-label mb-1">نام خانوادگی </label>
                                            <input value="{{ auth()->user()->last_name ?? auth()->user()->last_name }}" type="text" name="last_name" class="form-control form-control-sm" id="last_name" placeholder="نام خانوادگی ">
                                        </section>
